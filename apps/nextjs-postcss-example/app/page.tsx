...
export default function Home() {
  ...
  return (
    <main {...stylex.props(style.main, THEMES[themeIndex].theme, isDark ? darkTheme : lightTheme)}>
      ...
      <div {...stylex.props(style.localVisualTestImports)}>
        <Text>Local visual test imports</Text>
      </div>
...
const style = stylex.create({
  ...
  localVisualTestImports: {
    ...
    color: tokens.green7,
    backgroundColor: {
      [breakpoints.mobile]: tokens.pink7,
      default: tokens.red7,
    },
