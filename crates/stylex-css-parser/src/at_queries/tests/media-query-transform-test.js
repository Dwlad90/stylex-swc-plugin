...
describe('Media Query Transformer', () => {
  ...
  test.skip('basic usage: nested query', () => {
    const originalStyles = {
      gridColumn: {
        default: '1 / 2',
  ...
  test.skip('basic usage: complex object', () => {
    const originalStyles = {
      gridColumn: {
        default: '1 / 2',
        '@media (max-width: 1440px)': '1 / 4',
  ...
  test.skip('basic usage: lots and lots of max-widths', () => {
    const originalStyles = {
      gridColumn: {
        default: '1 / 2',
        '@media (max-width: 1440px)': '1 / 4',
  ...
  test.skip('basic usage: lots and lots of min-widths', () => {
    const originalStyles = {
      gridColumn: {
        default: '1 / 2',
  ...
  test.skip('basic usage: multiple heights', () => {
    const originalStyles = {
      foo: {
        gridRow: {
          default: '1 / 2',
  ...
  test.skip('basic usage: min/max heights', () => {
    const originalStyles = {
      foo: {
        gridRow: {
          default: '1 / 2',
  ...
  test.skip('single word condition', () => {
  ...
  test.skip('handles comma-separated (or) media queries', () => {
    const originalStyles = stylex.create({
      width: {
        default: '100%',
  ...
  test.skip('basic usage: does not modify single queries', () => {
    const originalStyles = {
      gridColumn: {
        default: '1 / 2',
        '@media (max-width: 1440px)': '1 / 4',
  ...
  test.skip('ignores legacy media query syntax', () => {
    const originalStyles = {
      width: '100%',
  ...
  test.skip('mixed min/max width and height', () => {
    const originalStyles = {
      foo: {
        gridColumn: {
          default: '1 / 2',
  ...
  test.skip('mixed min/max width and height with only height changing', () => {
    const originalStyles = {
      foo: {
        gridColumn: {
          default: '1 / 2',
  ...
  test.skip('mixed min/max width with ranges', () => {
    const originalStyles = {
      foo: {
        gridColumn: {
          default: '1 / 2',
