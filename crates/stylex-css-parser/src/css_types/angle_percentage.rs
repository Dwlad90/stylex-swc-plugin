...
Mirrors: packages/style-value-parser/src/css-types/angle-percentage.js
*/

use crate::{token_parser::TokenParser, css_types::{Angle, Percentage}};
use std::fmt::{self, Display};

/// Union type for angle or percentage values
/// Mirrors: AnglePercentage type in angle-percentage.js
...
impl AnglePercentage {
    ...
    /// Mirrors: anglePercentage parser in angle-percentage.js
...
/// Mirrors: anglePercentage export in angle-percentage.js
