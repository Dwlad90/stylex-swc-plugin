...
Mirrors: packages/style-value-parser/src/css-types/blend-mode.js
*/
...
/// Mirrors: BlendMode type in blend-mode.js
...
impl BlendMode {
    ...
    /// Mirrors: blendMode parser in blend-mode.js
        ...
        TokenParser::<SimpleToken>::token(SimpleToken::Ident(String::new()), Some("Ident"))
            .where_fn(|token| {
                if let SimpleToken::Ident(value) = token {
                    Self::is_valid_blend_mode(value)
                } else {
                    false
                }
...
mod tests {
    ...
    fn test_blend_mode_from_str() {
        ...
        assert_eq!(BlendMode::from_str("color-dodge"), Some(BlendMode::ColorDodge));
        assert_eq!(BlendMode::from_str("color-burn"), Some(BlendMode::ColorBurn));
        assert_eq!(BlendMode::from_str("hard-light"), Some(BlendMode::HardLight));
        assert_eq!(BlendMode::from_str("soft-light"), Some(BlendMode::SoftLight));
