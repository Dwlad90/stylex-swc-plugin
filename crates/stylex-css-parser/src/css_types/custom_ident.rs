...
Mirrors: packages/style-value-parser/src/css-types/custom-ident.js
*/
...
/// Mirrors: reservedKeywords in custom-ident.js
const RESERVED_KEYWORDS: &[&str] = &[
    "unset", "initial", "inherit", "default", "none", "auto", "normal", "hidden", "visible",
    "revert", "revert-layer",
];

/// CSS Custom Identifier
/// Mirrors: CustomIdentifier class in custom-ident.js
...
impl CustomIdentifier {
    ...
    /// Mirrors: CustomIdentifier.parser
...
mod tests {
    ...
    fn test_reserved_keywords_list() {
        ...
        // Should have exactly 11 keywords as defined in JS
