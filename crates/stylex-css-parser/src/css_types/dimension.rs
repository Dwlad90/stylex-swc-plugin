...
use super::{length::Length, time::Time, frequency::Frequency, resolution::Resolution};

/// Union type for all dimensional CSS values
/// Mirrors: Dimension type in dimension.js
...
impl Dimension {
    ...
    /// Mirrors: the logic in dimension.js
...
mod tests {
    ...
    fn test_dimension_display() {
        ...
        assert_eq!(freq.to_string(), "440Hz");
    ...
    fn test_is_valid_dimension_unit() {
        ...
        assert!(!Dimension::is_valid_dimension_unit("deg")); // This would be angle, not implemented yet
    }
