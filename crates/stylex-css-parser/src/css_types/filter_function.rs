...
impl FilterFunction {
    ...
    fn fn_name(name: &str) -> TokenParser<String> { TokenParser::<String>::fn_name(name) }

    fn number_or_percentage_to_number() -> TokenParser<f32> {
        number_or_percentage_parser().map(|v| match v {
    ...
    fn blur_parser() -> TokenParser<FilterFunction> {
        ...
        Self::fn_name("blur")
            ...
            .flat_map(move |len| close.clone().map(move |_| len.clone(), Some(")")), Some("close"))
    ...
    fn brightness_parser() -> TokenParser<FilterFunction> {
        ...
        Self::fn_name("brightness")
            ...
            .flat_map(move |v| close.clone().map(move |_| v, Some(")")), Some("close"))
    ...
    fn hue_rotate_parser() -> TokenParser<FilterFunction> {
        ...
        Self::fn_name("hue-rotate")
            ...
            .flat_map(move |a| close.clone().map(move |_| a.clone(), Some(")")), Some("close"))
