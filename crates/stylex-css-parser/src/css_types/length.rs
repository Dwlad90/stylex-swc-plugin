...
container-relative, and absolute units. Mirrors: packages/style-value-parser/src/css-types/length.js
*/
...
pub const UNITS_BASED_ON_VIEWPORT: &[&str] = &[
    "vh", "svh", "lvh", "dvh", "vw", "svw", "lvw", "dvw", "vmin", "svmin", "lvmin", "dvmin",
...
/// Mirrors: Length class in length.js
