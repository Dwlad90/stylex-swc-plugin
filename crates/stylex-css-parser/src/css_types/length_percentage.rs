...
Mirrors: packages/style-value-parser/src/css-types/length-percentage.js
*/

use crate::{token_parser::TokenParser, css_types::{Length, Percentage}};
use std::fmt::{self, Display};

/// Union type for length or percentage values
/// Mirrors: LengthPercentage type in length-percentage.js
...
impl LengthPercentage {
    ...
    /// Mirrors: lengthPercentage parser in length-percentage.js
...
/// Mirrors: lengthPercentage export in length-percentage.js
