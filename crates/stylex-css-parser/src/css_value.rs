/*!
Universal CSS Value System for JavaScript-Equivalent Parsing

This module implements a flexible value system that can represent any CSS value type,
enabling JavaScript-like dynamic parsing and type mixing in parser sequences.

Key features:
- Universal CssValue enum for any parsed result
- JavaScript-like property access (value.as_number(), etc.)
...
/// This enables JavaScript-like parsing where sequences can mix different types
...
mod tests {
    ...
    fn test_display_formatting() {
        ...
        let percent = CssValue::percentage(50.0);
        let dim = CssValue::dimension(10.0, "px");
        let func = CssValue::function("calc", vec![
