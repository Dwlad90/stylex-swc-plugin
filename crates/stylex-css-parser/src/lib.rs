...
mod lib_tests {
    ...
    fn test_javascript_compatible_imports() {
        ...
        use crate::{properties, lastMediaQueryWinsTransform};
        use crate::css_types::{Color, Length, Calc};
    ...
    fn test_error_types_comprehensive() {
        ...
        let errors = vec![
            CssParseError::ParseError { message: "parse error".to_string() },
            CssParseError::InvalidValue { value: "invalid".to_string() },
            CssParseError::UnexpectedEndOfInput,
            CssParseError::InvalidToken { token: "bad".to_string() },
        ];
