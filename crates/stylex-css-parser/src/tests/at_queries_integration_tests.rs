...
use crate::at_queries::{
  media_query_transform::last_media_query_wins_transform_internal, validate_media_query, MediaQuery, MediaQueryErrors,
};
...
mod media_query_validation_tests {
  ...
  fn test_validate_media_query_basic_syntax() {
    ...
    for query in valid_queries {
      ...
      let _result = std::panic::catch_unwind(|| validate_media_query(query));
...
mod media_query_parsing_tests {
  ...
  fn test_media_query_display() {
    ...
    let complex_query =
      MediaQuery::new("@media screen and (min-width: 600px) and (max-width: 1200px)".to_string());
    assert_eq!(
...
mod media_query_transform_tests {
  ...
  fn test_last_media_query_wins_transform_function_exists() {
    ...
    let result = last_media_query_wins_transform_internal(test_queries.clone());
...
mod media_query_integration_tests {
  ...
  fn test_comprehensive_media_query_workflow() {
    ...
    for query_str in query_strings {
      ...
      let transformed = last_media_query_wins_transform_internal(queries);
