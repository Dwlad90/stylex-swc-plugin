...
- Validates and type-checks individual CSS values at compile time
- Provides shared helpers for CSS shorthand expansion and
  normalization
- Used by the CSS ordering, generation, and transform layers to
  ensure consistent value handling
...
| Module | Purpose |
| --- | --- |
| `common` | Shared CSS value utilities and normalization helpers |
| `parser` | CSS value validation and type-checking logic |
