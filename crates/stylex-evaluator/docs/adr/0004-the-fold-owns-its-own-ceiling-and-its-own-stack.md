...
`stylex-transform/tests/transform_stylex_create_test/evaluation_depth_budget.rs` rather than
...
shallow siblings. See the budget check in `src/evaluate/cache.rs`.
