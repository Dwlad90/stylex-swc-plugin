...
`macro_rules!` macros for errors, panics and collection literals. Every
user-facing failure in the compiler is spelled through one of these, which is
what makes the `[StyleX]` prefix universal.
