//! Integration test to cover runtime-only (`cfg(not(test))`) resolve_path branches.
...
/// In runtime mode, resolve_path should reject non-file inputs and include the original path.
#[test]
