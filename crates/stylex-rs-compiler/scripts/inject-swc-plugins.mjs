...
const missingExports = requiredExports.filter(
  exportName => !jsContent.includes(`module.exports.${exportName}`)
);
...
const transformExportLineRegex =
  /^module\.exports\.transform\s*=\s*nativeBinding\.transform\s*;?$/m;
