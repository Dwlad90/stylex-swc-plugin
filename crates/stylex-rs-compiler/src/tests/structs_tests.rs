...
/// One ceiling, named the three ways a test needs it: the option a project
/// writes, the field the boundary reads, and the cap its own declaration sets.
///
