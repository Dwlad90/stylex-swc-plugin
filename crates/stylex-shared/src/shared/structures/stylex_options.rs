...
pub struct StyleXOptionsParams {
  ...
  pub enable_last_media_query_wins: Option<bool>,
...
impl Default for StyleXOptionsParams {
  fn default() -> Self {
    StyleXOptionsParams {
      ...
      enable_last_media_query_wins: Some(false),
...
pub struct StyleXOptions {
  ...
  pub enable_last_media_query_wins: bool,
...
impl Default for StyleXOptions {
  fn default() -> Self {
    StyleXOptions {
      ...
      enable_last_media_query_wins: false,
...
impl From<StyleXOptionsParams> for StyleXOptions {
  fn from(options: StyleXOptionsParams) -> Self {
    ...
    StyleXOptions {
      ...
      enable_last_media_query_wins: options.enable_last_media_query_wins.unwrap_or(false),
