...
export default function Home(_props: Props) {
    return <main {...{
        ...
        "data-style-src": "input.stylex.js:72"
    }}>
      <div {...{
        className: "display-x1jfb8zj justifyContent-xarpa2k alignItems-x1h91t0o fontSize-xmit1kp maxWidth-xmrzitl width-xh8yej3 zIndex-xhtitgo fontFamily-xh1z4oz",
        "data-style-src": "input.stylex.js:118"
    }}>
        <p {...{
      ...
      <div {...{
        ...
        "data-style-src": "input.stylex.js:92"
    }}>
          Next.js App Dir<span {...{
        className: "position-x1n2onr6 fontFamily-x6icuqf top-x13vifvy top-x1dgnge0 animationName-xjjucxr animationDuration-x1c74tu6 animationIterationCount-xa4qsjk animationTimingFunction-x1esw782",
        "data-style-src": "input.stylex.js:106"
    }}>♥️</span>️StyleX
        </h1>
          <Counter/>
      </div>
      ...
      <div {...{
        ...
        "data-style-src": "input.stylex.js:179"
    }}>
