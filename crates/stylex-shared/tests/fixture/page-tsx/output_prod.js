...
export default function Home(_props: Props) {
    return <main {...{
      ...
      <div {...{
        className: "x1jfb8zj xarpa2k x1h91t0o x1m46db1 xlql8t6 xh8yej3 xhtitgo xum72dy"
    }}>
        <p {...{
      ...
      <div {...{
        ...
        className: "x1n2onr6 x6icuqf x13vifvy xe3njyp x1r68wle x1c74tu6 xa4qsjk x1esw782"
    }}>♥️</span>️StyleX
        </h1>
          <Counter/>
      </div>
