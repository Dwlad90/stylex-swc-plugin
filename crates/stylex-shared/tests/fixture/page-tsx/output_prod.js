...
export default function Home(_props: Props) {
    return <main {...{
      ...
      <div {...{
        className: "x1jfb8zj xarpa2k x1h91t0o xfi3gsi xv4mccy xh8yej3 xhtitgo x1nlbcxq"
    }}>
        <p {...{
      ...
      <div {...{
        ...
        className: "x1n2onr6 x6icuqf x13vifvy x1e1ljn3 xq36ahf x1c74tu6 xa4qsjk x1esw782"
    }}>♥️</span>️StyleX
        </h1>
          <Counter/>
      </div>
