...
_inject2({
    ltr: ".gridAutoFlow-x1mt1orb{grid-auto-flow:column}",
    priority: 3000
});
_inject2({
    ltr: ".gridTemplateColumns-xernuvs{grid-template-columns:repeat(5,12%)}",
    priority: 3000
});
_inject2({
...
_inject2({
    ltr: ".gap-xmjcfx9{gap:8%}",
    priority: 2000
});
_inject2({
    ltr: ".backgroundColor-x1mdjlir{background-color:#2c3e50}",
    priority: 3000
});
_inject2({
...
_inject2({
    ltr: ".zIndex-x11uqc5h{z-index:100}",
    priority: 3000
});
_inject2({
...
_inject2({
    ltr: ".animationDuration-x1m9vv7p{animation-duration:1.2s}",
    priority: 3000
});
_inject2({
...
_inject2({
    ltr: ".animationTimingFunction-x4hg4is{animation-timing-function:ease-in-out}",
    priority: 3000
});
_inject2({
    ltr: ".height-x10buj8t{height:24%}",
    priority: 4000
});
_inject2({
    ltr: ".animationDelay-x1qdon1m{animation-delay:-1.1s}",
    priority: 3000
});
_inject2({
    ltr: ".height-x1lnynta{height:62%}",
    priority: 4000
});
_inject2({
    ltr: ".animationDelay-x123bg45{animation-delay:-1s}",
    priority: 3000
});
_inject2({
    ltr: ".height-x5yr21d{height:100%}",
    priority: 4000
});
_inject2({
...
_inject2({
    ltr: ".backgroundColor-xb4ade6{background-color:#ff4500}",
    priority: 3000
});
_inject2({
...
_inject2({
    ltr: ".height-xettwda{height:2rem}",
    priority: 4000
});
_inject2({
    ltr: ".width-xs5h3dt{width:2rem}",
    priority: 4000
});
_inject2({
    ltr: ".height-x1sh0tsm{height:4rem}",
    priority: 4000
});
_inject2({
    ltr: ".width-xekueh{width:4rem}",
    priority: 4000
});
_inject2({
