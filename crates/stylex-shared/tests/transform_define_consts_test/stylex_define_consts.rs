...
test!(
  ...
  transforms_constants_object_with_import_star,
  r#"
...
#[test]
#[should_panic(expected = "Invalid constant key: --small. Constant keys must not start with --")]
fn throws_error_for_constant_keys_that_start_with_dash_dash() {
  test_transform(
    Syntax::Typescript(TsSyntax {
      tsx: true,
      ..Default::default()
