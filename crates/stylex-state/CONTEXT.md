...
cannot be materialized the way a [folded function map](../stylex-transform/CONTEXT.md#folded-function-map) is,
...
Inside a fold it crosses as the [carried value](../stylex-transform/CONTEXT.md#carried-value) a group is, with
...
[chain](../stylex-transform/CONTEXT.md#reference-resolution-chain). A named specifier resolves to a theme
...
[chain](../stylex-transform/CONTEXT.md#reference-resolution-chain) probes them as the two sequential steps the
...
[stylex-transform ADR 0005](../stylex-transform/docs/adr/0005-the-memo-key-is-a-whole-subtree-hash.md). This
