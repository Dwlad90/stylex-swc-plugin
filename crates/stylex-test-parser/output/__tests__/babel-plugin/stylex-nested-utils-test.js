describe('stylex-nested-utils', ()=>{
    describe('flattenNestedVarsConfig', ()=>{
        ...
        test('throws on keys containing dots', ()=>{
            expect(()=>flattenNestedVarsConfig({
                    'button.primary': 'red'
    ...
    describe('flattenNestedConstsConfig', ()=>{
        ...
        test('throws on keys containing dots', ()=>{
            expect(()=>flattenNestedConstsConfig({
                    'spacing.sm': 4
                })).toThrow('Key "spacing.sm" must not contain the "." character');
        });
    });
    describe('flattenNestedStringConfig', ()=>{
        test('throws on keys containing dots', ()=>{
            expect(()=>flattenNestedStringConfig({
                    'color.brand': 'var(--x1)'
