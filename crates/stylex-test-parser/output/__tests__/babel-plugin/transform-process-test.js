...
describe('@stylexjs/babel-plugin', ()=>{
    describe('[transform] stylexPlugin.processStylexRules', ()=>{
        ...
        import * as stylex from '@stylexjs/stylex';
      `);
            expect(stylexPlugin.processStylexRules(metadata.stylex)).toMatchInlineSnapshot('""');
        });
      ...
      `);
        ...
        test('all rules (useLayers:true)', ()=>{
            ...
            const { metadata } = transform(fixture);
            expect(stylexPlugin.processStylexRules(metadata.stylex, useLayers)).toMatchInlineSnapshot(`
        "
