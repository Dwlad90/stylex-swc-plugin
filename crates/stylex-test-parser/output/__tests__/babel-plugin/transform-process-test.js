...
describe('@stylexjs/babel-plugin', ()=>{
    describe('[transform] stylexPlugin.processStylexRules', ()=>{
      ...
      `);
            ...
            expect(stylexPlugin.processStylexRules(metadata)).toMatchInlineSnapshot('":root, .x1nqdfg0{--x1i1e39s:blue;}"');
        });
      ...
      `);
            expect(stylexPlugin.processStylexRules(metadata, true)).toMatchInlineSnapshot(`
        "
