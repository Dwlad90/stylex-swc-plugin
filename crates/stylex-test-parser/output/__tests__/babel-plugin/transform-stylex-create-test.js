...
describe('@stylexjs/babel-plugin', ()=>{
    describe('[transform] stylex.create()', ()=>{
        ...
        `);
                expect(code).toMatchInlineSnapshot('"import * as stylex from \'@stylexjs/stylex\';"');
        ...
        `, {
                    env: {
                        shadow: (color, opacity)=>`0 4px 4px 2px color-mix(in srgb, ${color} ${opacity * 100}%, transparent)`
                    }
                });
                expect(code).toMatchInlineSnapshot(`
          "import * as stylex from '@stylexjs/stylex';
        ...
        `, {
                    env: {
                        opacity: (color, pct)=>`color-mix(in srgb, ${color} ${pct * 100}%, transparent)`
                    }
                });
                expect(code).toMatchInlineSnapshot(`
          "import * as stylex from '@stylexjs/stylex';
        ...
        describe('legacy / deprecated', ()=>{
          ...
          `, options).code).toMatchInlineSnapshot(`
