...
describe('@stylexjs/babel-plugin', ()=>{
    ...
    describe('[cross-file] nested tokens used in stylex.create()', ()=>{
      ...
      `, {
                filename: '/stylex/packages/tokens.stylex.js',
                ...hasteOpts
            });
            const { code, metadata } = transform(`
        import * as stylex from '@stylexjs/stylex';
      ...
      `, {
                filename: '/stylex/packages/component.js',
                ...hasteOpts
            });
      ...
      `, {
                filename: '/stylex/packages/theme.stylex.js',
                ...hasteOpts
            });
            expect(code).toContain('$$css');
            const allLtr = metadata.stylex.map((m)=>m[1].ltr).join('');
    ...
    describe('[cross-package] nested tokens from node_modules (commonJS)', ()=>{
      ...
      `, {
                filename: '/app/node_modules/@design-system/tokens/src/tokens.stylex.js',
                ...commonJSOpts
            });
            moduleResolve.mockImplementation((specifier)=>{
                if (specifier.includes('@design-system/tokens') && specifier.includes('tokens.stylex')) {
                    return new URL('file:///app/node_modules/@design-system/tokens/src/tokens.stylex.js');
                }
