...
var cleanExpect = (fn)=>expect(()=>{
        try {
            ...
            if (typeof error.message !== 'string') {
                throw new TypeError(`Expected a \`string\`, got \`${typeof error.message}\``);
            }
...
describe('@stylexjs/babel-plugin', ()=>{
    ...
    describe('[validation] propertyValidationMode config', ()=>{
        ...
        `, {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('border is not supported'));
            consoleSpy.mockRestore();
        });
