describe('stylex-define-vars test', ()=>{
    test('converts set of vars to CSS', ()=>{
        ...
        expect(jsOutput).toEqual({
            ...
            bgColorDisabled: `var(--${classNamePrefix + createHash(`${themeName}.bgColorDisabled`)})`,
            cornerRadius: `var(--${classNamePrefix + createHash(`${themeName}.cornerRadius`)})`,
    ...
    test('converts set of vars with nested at rules to CSS and includes key in variable name as prefix in debug mode', ()=>{
        ...
        expect(jsOutput).toEqual({
            ...
            bgColorDisabled: `var(--bgColorDisabled-${classNamePrefix + createHash(`${themeName}.bgColorDisabled`)})`,
            cornerRadius: `var(--cornerRadius-${classNamePrefix + createHash(`${themeName}.cornerRadius`)})`,
