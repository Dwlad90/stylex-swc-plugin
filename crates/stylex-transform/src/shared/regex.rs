...
pub(crate) static WHITESPACE_BRACKET_NORMALIZER_REGEX: Lazy<Regex> = Lazy::new(|| {
...
pub(crate) static WHITESPACE_FUNC_NORMALIZER_REGEX: Lazy<Regex> = Lazy::new(|| {
  Regex::new(r#"\(\s*+([^)]*?)\s*+\)\s*+,\s*+"#)
...
pub(crate) static CLEAN_CSS_VAR: Lazy<Regex> =
...
pub(crate) static MANY_SPACES: Lazy<Regex> =
...
pub(crate) static PSEUDO_PART_REGEX: Lazy<Regex> = Lazy::new(|| {
...
pub(crate) static STYLEX_CONSTS_IMPORT_REGEX: Lazy<Regex> = Lazy::new(|| {
