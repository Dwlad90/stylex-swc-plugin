...
//!
//! Owning the engine is a separate concern and lives in [`engine`]: which
//! expressions may fold is decided here, where they run is decided there, and
//! nothing in that answer turns on a rule this module applies.
