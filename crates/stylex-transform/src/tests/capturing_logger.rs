...
//! logs. This one wraps: this test binary prints with a logger of its own, and
//! `log` takes one logger for the whole process. What prints stays the wrapped
//! logger's decision, taken against the level it was built with, and is
//! unchanged.
//!
