...
_inject2({
    ltr: "@media (min-width: 1440px){.xp1lhok.xp1lhok{color:var(--x1gey9a0)}}",
    priority: 3200
});
_inject2({
    ltr: "@media (min-width: 1200px) and (max-width: 1439px){.x28tqh0.x28tqh0{color:var(--xo0k5im)}}",
    priority: 3200
});
_inject2({
...
export const styles = {
    root: {
        kMwMTN: "x1fm9ujy xp1lhok x28tqh0 xqw8h0p x1bhj7sf x1p9ejzw xw70vyp",
        $$css: true
    }
};
