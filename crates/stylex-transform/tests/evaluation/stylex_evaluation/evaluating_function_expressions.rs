...
stylex_test_transform!(
  object_values_with_legal_non_object_args,
  |_tr| EvaluationStyleXFirstStatementTransform::default_with_pass(),
  r#"
...
stylex_test_transform!(
  object_entries_with_legal_non_object_args,
  |_tr| EvaluationStyleXFirstStatementTransform::default_with_pass(),
  r#"
...
stylex_test_transform!(
  methods_called_by_string_should_be_bind,
  |_tr| EvaluationStyleXFirstStatementTransform::default_with_pass(),
  r#"
