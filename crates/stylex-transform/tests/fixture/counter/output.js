...
export default function Counter() {
    ...
    return <div className="input__styles.container x78zum5 x6s0dn4 xl56j7k x1q0g3np x12xgqvu xmkeg23 x1y0btm7 xqpy6nh x87erls x1alyrvt x1749g51" data-style-src="tests/fixture/counter/input.stylex.js:40">
      <button className="input__styles.button x78zum5 x6s0dn4 xl56j7k x17frcva x1plog1 xgopyf5 xpotius x1gk0e8 x10vqmf9 xnha941 xc342km xng3xce xvm41bv xsbzlvg x1i5nj67 x1ypdohk xtqx43c x1u4xmye xglsxx3" data-style-src="tests/fixture/counter/input.stylex.js:53" onClick={()=>setCount((c)=>c - 1)}>
        -
      </button>
      <div {...{
        0: {
            className: "input__styles.count xtqx43c x3stwaq xxzazoc x1843ork x2b8uid xum72dy",
            "data-style-src": "tests/fixture/counter/input.stylex.js:81"
        },
        1: {
            className: "input__styles.count x3stwaq xxzazoc x1843ork x2b8uid xum72dy input__styles.largeNumber xs6c6ls",
