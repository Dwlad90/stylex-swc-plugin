...
The plugin architecture is a port of
[`stylex-webpack`](https://github.com/SukkaW/stylex-webpack) by
[SukkaW](https://github.com/SukkaW), adapted to the
`@stylexswc/rs-compiler` NAPI-RS Rust compiler.
