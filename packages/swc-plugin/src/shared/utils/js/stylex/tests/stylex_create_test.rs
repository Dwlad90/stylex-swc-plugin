...
mod stylex_create {
  ...
  use crate::shared::{
    ...
    utils::{
      ...
      css::factories::{array_expression_factory, object_expression_factory},
      js::stylex::stylex_create::stylex_create_set,
    },
  };
          ...
          .map(|(key, value)| {
            key_value_creator(
              ...
              object_expression_factory(
                value
                  .iter()
                  .map(|v| prop_or_spread_string_creator(v.0, v.1))
                  .collect(),
              )
              .unwrap(),
            )
      ...
      object.insert(
        ...
        value
          ...
          .map(|(key, value)| {
            ...
            key_value_creator(key, array_expression_factory(elems).unwrap())
          })
          .collect(),
      );
    }
