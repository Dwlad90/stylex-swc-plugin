...
mod class_methods {
  ...
  use crate::shared::utils::{
    common::prop_or_spread_string_creator,
    css::factories::object_expression_factory,
    js::stylex::stylex_types::{ValueWithDefault, FN_MAP},
  };
  ...
  fn type_factory(syntax: &str, value: &str) -> Expr {
    object_expression_factory(vec![
      prop_or_spread_string_creator("syntax", format!("<{}>", syntax).as_str()),
      prop_or_spread_string_creator("value", value),
    ])
    .unwrap()
  }
